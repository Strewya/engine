...
public:
	...
	/// </para>
	/// </remarks>
	void AddDirectory( const std::string& wszDirectory, BOOL bWatchSubtree, DWORD dwNotifyFilter, DWORD dwBufferSize=16384 );
	...
	bool Pop(DWORD& dwAction, std::string& wstrFilename);

	// "Push" is for usage by ReadChangesRequest.  Not intended for external usage.
	void Push(DWORD dwAction, const std::string& wstrFilename);
