...
function makeStates(asm)
	...
	function s.fenter(game)
		game.m_animation:startAnimation(game.m_player.m_animationPlayerID, game.m_animationCache:getResourceID("idle_to_walk"), 3);
	end;
	...
	s = State("walk");
	function s.fenter(game)
		game.m_animation:startAnimation(game.m_player.m_animationPlayerID, game.m_animationCache:getResourceID("walk"), 1);
	...
	s = State("jump");
	function s.fenter(game)
		game.m_animation:startAnimation(game.m_player.m_animationPlayerID, game.m_animationCache:getResourceID("jump"), 1);
	end;
	function s.fupdate(game, asm)
	...
	s = State("fall");
	function s.fenter(game)
		game.m_animation:startAnimation(game.m_player.m_animationPlayerID, game.m_animationCache:getResourceID("fall"), 1);
	end;
	function s.fupdate(game, asm)
		--if(gState.yVel == 0) then
		if(not game.m_animation:isRunning(game.m_player.m_animationPlayerID)) then
