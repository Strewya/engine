...
#define SAFE_RELEASE(ptr) if(ptr != nullptr) { ptr->Release(); ptr = nullptr; }
	...
	DXRenderer::DXRenderer(Win32::Window* window)
		: m_screenW(window->getSizeX()), m_screenH(window->getSizeY()),
		m_window(*window), m_dev(nullptr), m_devcon(nullptr), m_swapchain(nullptr), m_renderTarget(nullptr),
